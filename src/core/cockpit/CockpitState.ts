...
// SEPARATE from the shared UsageEvent enums and from ObservedLimitSample
// (the native statusLine metadata shape).
//
...
import type { AccuracyLabel, AgentId, ProviderId } from '../usage/UsageEvent';
