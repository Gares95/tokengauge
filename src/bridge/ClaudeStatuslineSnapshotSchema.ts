// Claude statusLine bridge snapshot boundary.
//
// The shape the opt-in Claude statusLine bridge accepts. The full documented
// statusLine payload is RICH and carries FORBIDDEN fields (Pitfall 5): `cwd`,
...
// safe writer's extra fields (`source`, `timestamp`, `resets_at_iso`,
...
//
// ObservedLimitSampleGuard's Redactor forbidden-content scan is the second, defence-in-
// depth backstop after this schema.
...
const RateLimitWindowSchema = z
  .object({
    ...
    // ISO form emitted alongside the epoch by the safe writer; preferred by the
