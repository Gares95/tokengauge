...
//
// stats-cache.json is a NATIVE structured per-model cost/model source: the
// FILE carries per-model input/output/cache tokens, costUSD, contextWindow,
// and the strict schema parses them, but the EMITTED candidates carry only
// model/cost — NEVER session/5h or weekly/7d limit
