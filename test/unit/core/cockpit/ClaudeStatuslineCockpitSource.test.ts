...
// reach the candidate. The path is INDEPENDENT of the observed-limit bridge.
...
suite('ClaudeStatuslineCockpitSource: statusLine -> cockpit candidate', () => {
  // The privacy-safe writer's EXACT shape (session_id_hash, no raw
  // session_id, model.display_name, resets_at_iso, extra context_window fields)
  // must parse and map correctly — the bug was this snapshot being rejected.
